   ...
   public static class BWFMenu
   {
      ...
      private static void ShowInfo()
      {
         EditorUtility.DisplayDialog($"{Util.Constants.ASSET_NAME} - About",
            $"Version: {Util.Constants.ASSET_VERSION}{System.Environment.NewLine}{System.Environment.NewLine}© 2015-2021 by {Util.Constants.ASSET_AUTHOR}{System.Environment.NewLine}{System.Environment.NewLine}{Util.Constants.ASSET_AUTHOR_URL}{System.Environment.NewLine}", "Ok");
      }
   }
}
#endif
